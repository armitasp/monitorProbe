...
my @wpa = `/usr/sbin/wpa_supplicant -Dnl80211 -iwlan0 -c /etc/eduroam_monitor/wpa_conf/eduroam-peap-mschap-anon.conf -B`;
sleep  20;
...
print ("test=peap_mschap_anon&result=$result&message=$error&time=$time_stamp");
