...
my @wpa = `/usr/sbin/wpa_supplicant -Dnl80211 -iwlan0 -c /etc/eduroam_monitor/wpa_conf/eduroam-ttls-mschap-rfc.conf -B`;
sleep  20;
...
print ("test=ttls_mschap_rfc&result=$result&message=$error&time=$time_stamp");
